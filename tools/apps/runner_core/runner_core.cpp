...
const std::unordered_map<std::string, screen_fn_t> k_screen_registry = {
    ...
    {"seed_transcribe_freeform_qr_screen", seed_transcribe_freeform_qr_screen},
    ...
    {"seed_address_verification_success_screen", seed_address_verification_success_screen},
    ...
    {"seed_transcribe_seedqr_format_screen", seed_transcribe_seedqr_format_screen},
    {"tools_address_explorer_address_list_screen", tools_address_explorer_address_list_screen},
    {"tools_address_explorer_address_type_screen", tools_address_explorer_address_type_screen},
    {"power_options_screen", power_options_screen},
