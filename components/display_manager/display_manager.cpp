...
void init(void)
{
    ...
    {
        bsp_touch_init(i2c_bus_handle, EXAMPLE_LCD_H_RES, EXAMPLE_LCD_V_RES, EXAMPLE_DISPLAY_ROTATION);
    }
    else
    {
        bsp_touch_init(i2c_bus_handle, EXAMPLE_LCD_V_RES, EXAMPLE_LCD_H_RES, EXAMPLE_DISPLAY_ROTATION);
    }
