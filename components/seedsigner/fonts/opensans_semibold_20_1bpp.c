 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --no-compress --stride 1 --align 1 --font OpenSans-SemiBold.ttf --range 32-127 --format lvgl -o opensans_semibold_20_1bpp.c
 ******************************************************************************/
...
#ifndef OPENSANS_SEMIBOLD_20_1BPP
#define OPENSANS_SEMIBOLD_20_1BPP 1
#endif

#if OPENSANS_SEMIBOLD_20_1BPP
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+0024 "$" */
    0xc, 0x6, 0x1f, 0xff, 0xac, 0xc6, 0x61, 0xf0,
    0x7c, 0xf, 0x6, 0xc3, 0x71, 0xbf, 0xf3, 0xf0,
    0x30, 0x18,

    /* U+0025 "%" */
    0x78, 0x38, 0xf8, 0x30, 0xcc, 0x60, 0xcc, 0x60,
    0xcc, 0xc0, 0xcc, 0xdc, 0xfd, 0xa6, 0x7b, 0x63,
    0x3, 0x63, 0x6, 0x63, 0x6, 0x63, 0xc, 0x67,
    0x8, 0x3e, 0x18, 0x1c,

    /* U+0026 "&" */
    0x1e, 0x1, 0xfe, 0x6, 0x18, 0x18, 0x60, 0x63,
    0x80, 0xdc, 0x3, 0xe0, 0x1f, 0x86, 0xe7, 0x3b,
    0xe, 0xcc, 0x1f, 0x38, 0x78, 0x7f, 0xb0, 0xfc,
    0x60,
    ...
    /* U+0028 "(" */
    0x31, 0x98, 0xce, 0x63, 0x18, 0xc6, 0x31, 0x8e,
    0x31, 0x86, 0x30,
    ...
    /* U+002A "*" */
    0x1c, 0xc, 0x2, 0x1d, 0x7f, 0xf8, 0xe0, 0xd8,
    0xee, 0x22, 0x0,
    ...
    0x30, 0x18, 0xe, 0x7, 0x3, 0x81, 0x80, 0xff,
    0xff, 0xf0,
    ...
    0xc, 0x63, 0xc, 0xe1, 0x9f, 0xff, 0xff, 0x80,
    0xc0, 0x18, 0x3, 0x0,
    ...
    /* U+0036 "6" */
    0xf, 0x8f, 0xe7, 0x1, 0x80, 0xc0, 0x37, 0xcf,
    ...
    0x0, 0xc1, 0xfc, 0x1f, 0xc0, 0x3c, 0x3, 0x60,
    ...
    /* U+004D "M" */
    0xf0, 0xf, 0xe0, 0x3f, 0xc0, 0x7f, 0xc1, 0xbd,
    ...
    /* U+0053 "S" */
    0x3f, 0x3f, 0xf8, 0x58, 0xc, 0x3, 0x1, 0xf0,
    ...
    /* U+0056 "V" */
    0xe0, 0x36, 0x7, 0x60, 0x77, 0x6, 0x30, 0xe3,
    0xc, 0x38, 0xc1, 0x9c, 0x19, 0x81, 0xd8, 0xf,
    0x80, 0xf0, 0xf, 0x0, 0x70,

    /* U+0057 "W" */
    0xe0, 0xe0, 0xec, 0x1c, 0x19, 0x83, 0x83, 0x30,
    0xd8, 0x67, 0x1b, 0x1c, 0x63, 0x63, 0xc, 0xec,
    0x61, 0x98, 0xcc, 0x3b, 0x1b, 0x83, 0x63, 0x60,
    0x78, 0x2c, 0xf, 0x7, 0x81, 0xe0, 0xe0, 0x1c,
    0x1c, 0x0,
    ...
    /* U+005C "\\" */
    0xe0, 0x60, 0x60, 0x70, 0x30, 0x30, 0x18, 0x18,
    ...
    /* U+005E "^" */
    0xc, 0x3, 0x81, 0xe0, 0x6c, 0x33, 0xc, 0x66,
    0x19, 0x83, 0x40, 0xc0,
    ...
    /* U+0061 "a" */
    0x3e, 0x3f, 0x90, 0x60, 0x33, 0xfb, 0xff, 0x87,
    ...
    0xf0, 0xf8, 0x60, 0x1f, 0xe7, 0xff, 0x3, 0xc0,
    0xf8, 0x7f, 0xf8, 0xf8,
    ...
    0xb8, 0xd8, 0x7c, 0x3f, 0x19, 0xcc, 0x76, 0x1b,
    0xe,
    ...
    /* U+0073 "s" */
    0x3e, 0xff, 0xc0, 0xc0, 0x70, 0x3e, 0x7, 0x3,
    0x83, 0xff, 0xfc,
    ...
    /* U+0077 "w" */
    0xe1, 0xc3, 0x63, 0xc7, 0x63, 0xc6, 0x63, 0xc6,
    0x73, 0x66, 0x36, 0x6e, 0x36, 0x6c, 0x36, 0x2c,
    0x1c, 0x3c, 0x1c, 0x3c, 0x1c, 0x38,
    ...
    /* U+007B "{" */
    0x7, 0x1f, 0x18, 0x18, 0x18, 0x18, 0x18, 0x38,
    0xf0, 0xf0, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18,
    0x1f, 0xf,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 150, .adv_w = 85, .box_w = 3, .box_h = 5, .ofs_x = 1, .ofs_y = -3},
    ...
    {.bitmap_index = 348, .adv_w = 89, .box_w = 4, .box_h = 14, .ofs_x = 0, .ofs_y = -3},
    ...
    {.bitmap_index = 602, .adv_w = 205, .box_w = 11, .box_h = 14, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 622, .adv_w = 173, .box_w = 9, .box_h = 14, .ofs_x = 2, .ofs_y = 0},
    ...
    {.bitmap_index = 753, .adv_w = 205, .box_w = 10, .box_h = 14, .ofs_x = 2, .ofs_y = 0},
    ...
    {.bitmap_index = 942, .adv_w = 106, .box_w = 5, .box_h = 18, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 954, .adv_w = 125, .box_w = 8, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 968, .adv_w = 106, .box_w = 5, .box_h = 18, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 980, .adv_w = 172, .box_w = 10, .box_h = 9, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 992, .adv_w = 137, .box_w = 9, .box_h = 2, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 995, .adv_w = 189, .box_w = 4, .box_h = 3, .ofs_x = 4, .ofs_y = 12},
    {.bitmap_index = 997, .adv_w = 186, .box_w = 9, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1010, .adv_w = 199, .box_w = 10, .box_h = 15, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1029, .adv_w = 158, .box_w = 8, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    ...
    {.bitmap_index = 1087, .adv_w = 178, .box_w = 10, .box_h = 16, .ofs_x = 1, .ofs_y = -5},
    ...
    {.bitmap_index = 1162, .adv_w = 306, .box_w = 16, .box_h = 11, .ofs_x = 2, .ofs_y = 0},
    ...
    {.bitmap_index = 1271, .adv_w = 126, .box_w = 7, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    ...
    {.bitmap_index = 1351, .adv_w = 172, .box_w = 10, .box_h = 16, .ofs_x = 0, .ofs_y = -5},
    {.bitmap_index = 1371, .adv_w = 153, .box_w = 8, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1382, .adv_w = 124, .box_w = 8, .box_h = 18, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 1400, .adv_w = 176, .box_w = 2, .box_h = 20, .ofs_x = 5, .ofs_y = -5},
    {.bitmap_index = 1405, .adv_w = 119, .box_w = 7, .box_h = 18, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 1421, .adv_w = 183, .box_w = 10, .box_h = 3, .ofs_x = 1, .ofs_y = 6}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t opensans_semibold_20_1bpp = {
#else
lv_font_t opensans_semibold_20_1bpp = {
#endif
...
#endif /*#if OPENSANS_SEMIBOLD_20_1BPP*/
